        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <p class="lead mb-4">Welcome to E-Books, your premier digital library destination. Since our founding in 2020, we've been passionate about making literature accessible to everyone, everywhere.</p>
